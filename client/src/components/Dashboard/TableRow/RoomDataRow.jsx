...
const RoomDataRow = ({ room, handelDelete, refetch }) => {
     ...
     return (
          <tr>
               ...
               <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    ...
                    {/* Delete modal */}
                    <DeleteModal isOpen={isOpen} handelDelete={handelDelete} id={room._id} closeModal={closeModal} />
               </td>
               <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                    <button
                    ...
                    {/* Update Modal */}
                    <UpdateRoomModal isOpen={isEditModalOpen} setIsEditModalOpen={setIsEditModalOpen} room={room} refetch={refetch} />
               </td>
          </tr>
     )
}
